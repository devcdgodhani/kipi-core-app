...
import { OrderModel, ShipmentModel, CourierModel } from '../db/mongodb';
...
const RUN_TEST = async () => {
  try {
    ...
    const etaResult = await etaService.calculateETA('400001', courier._id.toString(), '110001');
    ...
    await CourierModel.deleteOne({ _id: courier._id });
