 ...
 */
export class PaymentRefundService extends MongooseCommonService<IPaymentRefundAttributes, IPaymentRefundDocument> implements IPaymentRefundServiceContract {
