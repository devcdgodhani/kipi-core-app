...
import { IWebhookHandlerService } from '../contracts/webhookHandlerServiceInterface';
...
export class WebhookHandlerService 
  ...
  implements IWebhookHandlerService {
   ...
   */
  public generateEventId(provider: string, payload: any): string {
   ...
   */
  public determineEventType(provider: PAYMENT_GATEWAY, payload: any): string {
    switch (provider) {
