...
import { IPaymentGateway } from '../contracts/paymentGatewayInterface';
import { IPaymentGatewayService } from '../contracts/paymentGatewayServiceInterface';
 ...
 */
export class PaymentGatewayService extends MongooseCommonService<IPaymentGatewayAttributes, IPaymentGatewayDocument> implements IPaymentGatewayService {
  constructor() {
   ...
   */
  async getGatewayService(gatewayName: PAYMENT_GATEWAY): Promise<IPaymentGateway> {
