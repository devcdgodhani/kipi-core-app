                ...
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {myRefunds.map(refund => (
                            <div key={refund._id} className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">{formatDate(refund.initiatedAt)}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between pl-13">
                                    <p className="text-xs text-gray-500">Refund ID: {refund.refundNumber}</p>
