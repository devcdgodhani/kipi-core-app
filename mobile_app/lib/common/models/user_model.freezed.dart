...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, firstName: $firstName, lastName: $lastName, mobile: $mobile, countryCode: $countryCode, profilePicture: $profilePicture, type: $type, status: $status, referralCode: $referralCode, usedReferralCode: $usedReferralCode, isEmailVerified: $isEmailVerified, isMobileVerified: $isMobileVerified, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
