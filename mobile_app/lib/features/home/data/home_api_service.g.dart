...
class _HomeApiService implements HomeApiService {
  ...
  @override
  Future<List<Banner>> getBanners(Map<String, dynamic> filters) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(filters);
    final _options = _setStreamType<List<Banner>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<List<Category>> getCategories(Map<String, dynamic> filters) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<List<FlashDeal>> getActiveFlashDeals() async {
    ...
    final _options = _setStreamType<List<FlashDeal>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<FlashDeal> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => FlashDeal.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
