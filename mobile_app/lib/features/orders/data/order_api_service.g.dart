...
class _OrderApiService implements OrderApiService {
  ...
  @override
  Future<List<Order>> getAll(Map<String, dynamic> filters) async {
  ...
  @override
  Future<Order> getOne(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> cancel(Map<String, String> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
